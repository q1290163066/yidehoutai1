...
export default class AddReceive extends Component {
    ...
    getCounty(province, city) {
        ...
        gc2['广东']['广州'] = ['广州市','从化', '增城','越秀','海珠','荔湾','天河','白云','黄埔','萝岗','番禺','花都'];
        ...
        switch (name) {
            ...
            case "province":
                ...
                this.setState({
                    ...
                    cities: this.getCity(e),

                    city:this.getCity(e)[0],

                    counties:this.getCounty(e, this.getCity(e)[0])
            ...
            case "city":
                ...
                this.setState({
                    ...
                    counties: this.getCounty(this.state.province, e),
    ...
    render() {
        ...
        return (
            ...
            <div className="col-md-9">
                ...
                <Select defaultValue="省份" style={{ width: 120 }} onChange={this.handleChange.bind(this, "province")}>
                ...
                <Select defaultValue="城市" style={{ width: 120 }} onChange={this.handleChange.bind(this, "city")}>
